...
using SellPhoneUntilities.Exceptions;
...
namespace Webapi.Catalog.Products
{
    public class ProductService :  IProductService
    {
        ...
        public ProductService(SellPhoneDbContext context, IStorageService storageService)
        {
            _context = context;
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new SellPhoneException($"Cannot find a product: {productId}");
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if (product == null || productTranslations == null) throw new SellPhoneException($"Cannot find a product with id: {request.Id}");
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if(product ==null) throw new SellPhoneException($"Cannot find a product with id: {productId}");
        ...
        public async Task<int> RemoveImage( int imageId)
        {
            ...
            if (productImage == null)
                throw new SellPhoneException($"Cannot find an image with id {imageId}");
